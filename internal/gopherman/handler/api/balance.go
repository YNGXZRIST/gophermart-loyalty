...
func (h *Handler) GetBalance(w http.ResponseWriter, r *http.Request) {
	...
	if res.Err != nil {
		lerr := labelerrors.NewLabelError(labelAPIHandler+".GetBalance", res.Err)
	...
	if err != nil {
		lerr := labelerrors.NewLabelError(labelAPIHandler+".GetBalance.Marshal", err)
...
func (h *Handler) MakeWithdraw(w http.ResponseWriter, r *http.Request) {
	...
	if res.Err != nil {
		lerr := labelerrors.NewLabelError(labelAPIHandler+".MakeWithdraw", res.Err)
